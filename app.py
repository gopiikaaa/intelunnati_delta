...
def main():
    ...
    st.title("Contract Analyzer and Highlighter")
    ...
    st.markdown('3. Click on the "Submit" button after uploading both documents.')
    st.markdown('4. Choose between "Highlight Text" to see differences or "Extract Clauses" to view specific sections.')
    
    # Home page for uploading documents
    if st.session_state.page == 'home':
        st.write("Upload your document and the template to highlight word differences and view different clauses.")
    ...
    if st.session_state.page == 'options' and st.session_state.contract_text and st.session_state.template_text:
        if st.button("Highlight Text", key="highlight_text"):
            st.session_state.page = 'highlighted_deviations'
    ...
    if st.session_state.page == 'highlighted_deviations' and st.session_state.contract_text and st.session_state.template_text:
        ...
        st.subheader("Highlighted Differences (Words Not in Template)")
